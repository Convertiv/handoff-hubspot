...
const buildImageField = (id: string, property: PropertyDefinition, groupId: string | undefined) => {
...
export const buildIconField = (id: string, property: PropertyDefinition, groupId: string | undefined) => {
